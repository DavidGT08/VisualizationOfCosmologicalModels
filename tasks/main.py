...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("./icon/icons8-astronomy-50.png"))
        self.setWindowTitle("Menu GUI")

        # Initialize UI elements
        self.title_label = self.ui.title_label
        self.title_label.setText("CosmoVis")

        self.title_icon = self.ui.title_icon
        self.title_icon.setText("")
        self.title_icon.setPixmap(QPixmap("./icon/icons8-astronomy-50.png"))
